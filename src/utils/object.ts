...
export type fieldMapper<T extends object> = (
  value: T[keyof T],
  field: keyof T,
) => T[keyof T];

export function objectInplaceMap<T extends object>(
  object: T,
  f: fieldMapper<T>,
): T {
...
export function objectCreateMap<T extends object>(
  object: T,
  f: fieldMapper<T>,
): T {
  const res = {} as T;
...
export function objectProxyMap<T extends object>(
  object: T,
  f: fieldMapper<T>,
): T {
